...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Petit Génie — Le conte interactif pour apprendre" },
      { name: "description", content: "Application éducative bilingue français/anglais pour enfants de 6 à 10 ans en Afrique de l'Ouest. Apprenez l'alphabet, les maths et les sciences par des contes interactifs." },
      { name: "author", content: "Petit Génie" },
      { name: "theme-color", content: "#a34e36" },
      { property: "og:title", content: "Petit Génie — Le conte interactif pour apprendre" },
      { property: "og:description", content: "Apprends l'alphabet, les maths et les sciences à travers des contes interactifs avec Petit Génie." },
